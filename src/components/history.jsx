  ...
  useEffect(() => {
    ...
    const fetchMedications = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:8000/user_medications/${userEmail}`);
    ...
    const fetchSkincareRoutine = async () => {
      try {
        ...
        const response = await axios.get(`http://localhost:8000/get_skincare/${userEmail}`);
